...
Optimized for 1GB RAM hosts.

Pipeline per scene:
  1. Download TWO image variants (same prompt, different Pollinations seed),
     forced to a lower resolution to cut memory/network load
  ...
  4. Reuse a cached ambient background pad (ffmpeg-synthesized once per
     root note, then cheaply trimmed) mixed under the voiceover
